...
*/
         ...
         * @return intersection
         */
        private static DPoint getIntersection(DPoint point1, Coordinate v1, DEdge anEdge) throws DelaunayError {
	 ...
	 *
	 */
	private static Coordinate getNormal(DTriangle triangle) {
	 ...
	 */
	private static Coordinate get3DVector(DTriangle triangle) {
		Coordinate pente;
                        ...
                        if (aTriangle != null) {
                                ...
                                while (!ended) {
                                        ...
                                        if (theElement instanceof DTriangle) {
                                                ...
                                                DPoint intersection = null;
                                                Coordinate theSlope = get3DVector(aTriangle);
