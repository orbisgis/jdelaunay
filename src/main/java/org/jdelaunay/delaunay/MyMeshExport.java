...
public class MyMeshExport {
	 ...
	 */
	public static MyMesh importTIN_triangle(String path) throws DriverException, DriverLoadException, DataSourceCreationException, DelaunayError
	{
